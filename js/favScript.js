...
function handleFavMovies() {
  ...
  Array.from(favouiteMoviesList).forEach((element, index) => {
    listFav.innerHTML += `
    <li class="card mb-3" style="max-width: 540px; font-family:'Metropolis', cursive;">
      <div   class="row g-0">
        <div class="col-md-4">
          <img src=${element.Poster} class="img-fluid rounded-start" alt="movie_poster" style="height:50vh"></img>
        </div>
        <div  class="col-md-8">
          <div class="card-body">
