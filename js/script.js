const api_url = "https://www.omdbapi.com/?apikey=316c6b24";
...
async function handleMoiveTitle(result) {
  ...
  if (result.length > 2) {
    ...
    if (data.Response === "False") {
      ...
      //change inside html
      searchDownbar.innerHTML = `
      <div class="poster_container container" style="width:40%; flex-wrap:wrap">
      <img src=${data.Poster} alt="movie_poster"></img>
      </div>
      <div class="card-body" style="font-family: 'Metropolis', cursive; margin:auto">
